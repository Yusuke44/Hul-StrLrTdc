...
set_clock_groups -name async_sys_gmii -asynchronous -group clk_sys -group -group clk_indep -group clk_spi -group {clk_fast clk_slow clk_tdc0 clk_tdc1 ckl_tdc2 clk_tdc3}
